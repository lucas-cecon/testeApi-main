...
class AlunoController extends Controller
{
    ...
    public function armazenar(Request $request)
    {
        ...
        return redirect()->route('alunos.listar')->with(['success' => 'Aluno criado com sucesso!', 'alunos' => $alunos]);
    }
    ...
    public function atualizarAluno(Request $request, $id)
    {
        ...
        return redirect()->route('dashboard.rh.visualizar_aluno', ['id' => $aluno->id_aluno])->with('success', 'Informações do aluno atualizadas com sucesso.');
    }
