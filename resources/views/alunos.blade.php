...
<body class="font-inter bg-gray-100">
    ...
    'pageTitle' => 'Dashboard'
        ...
        <a href="{{ route('alunos.criar') }}"> <button class="new-order-btn"> <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="h-4 w-4">
        ...
        <thead class="bg-gray-100 text-gray-600 text-sm uppercase font-semibold">
                    <tr>
                        <th class="border border-gray-300 px-4 py-2 text-left">ID</th> <!-- Adicionando o cabeçalho para ID -->
                        ...
                        <th class="border border-gray-300 px-4 py-2 text-left">Apm Status</th> <!-- Adicionando o cabeçalho para Apm Status -->
                ...
                <tbody class="text-gray-700 text-sm">
                    @foreach ($alunos as $aluno)
                        <tr  class="border-b">
                            <td class="border border-gray-300 px-4 py-2">{{ $aluno->id_aluno }}</td> <!-- Exibindo o ID do aluno -->
                            ...
                            <td class="border border-gray-300 px-4 py-2">{{ $aluno->curso->curso ?? 'N/A' }}</td> <!-- Corrigido para 'curso' -->
                            <td class="border border-gray-300 px-4 py-2">{{ $aluno->statusAluno->status ?? 'N/A' }}</td>
                            <td class="border border-gray-300 px-4 py-2">{{ $aluno->apmStatus->status ?? 'N/A' }}</td> <!-- Adicionando a exibição do Apm Status -->
