            ...
            <h2 class="text-lg font-bold mb-4">Editar aluno</h2>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4"> <!-- Responsivo: 1 coluna em telas pequenas, 2 colunas em telas maiores -->
                    ...
                    <div class="form-group flex flex-col">
                        ...
                        <input type="text" name="nome" class="form-control bg-gray-200 border border-red-500 p-2 rounded-md w-full" value="{{ $aluno->nome }}" required>
                    </div>
                    <div class="form-group flex flex-col">
                        <label for="horario_novo" class="font-bold mb-2">CPF:</label>
                        <input type="text" name="cpf_aluno" class="form-control bg-gray-200 border border-red-500 p-2 rounded-md w-full" value="{{ $aluno->cpf_aluno }}" required>
                    </div>

                    <!-- Horário Antigo -->
                    <div class="form-group flex flex-col">
                        <label for="gestor_responsavel" class="font-bold mb-2">RG:</label>
                        <input type="text" name="rg" class="form-control bg-gray-200 border border-red-500 p-2 rounded-md w-full" value="{{ $aluno->rg }}" required>
                    </div>

                    <!-- Horário Novo -->
                    <div class="form-group flex flex-col">
                        <label for="descricao" class="font-bold mb-2">Matrícula:</label>
                        <input name="descricao" name="n_matricula" type="text" class="form-control bg-gray-200 border border-red-500 p-2 rounded-md w-full" value="{{ $aluno->n_matricula }}" required>
                    </input>
                    </div>

                    <div class="form-group flex flex-col">
                        <label for="data-inicio" class="font-bold mb-2">Curso:</label>
                        <select type="text" name="curso" class="form-control bg-gray-200 border border-red-500 p-2 rounded-md w-full" value="{{ $aluno->curso->nome ?? 'N/A' }}" required>
                    ...
                    <div class="form-group flex flex-col">
                        ...
                        <select type="text" name="status_aluno" class="form-control bg-gray-200 border border-red-500 p-2 rounded-md w-full" value="{{ $aluno->statusAluno->nome ?? 'N/A' }}" required>
                    ...
                    <div class="form-group flex flex-col">
                        ...
                        <input type="text" name="email" class="form-control bg-gray-200 border border-red-500 p-2 rounded-md w-full" value="{{ $aluno->email }}" required>
                    ...
                    <div class="flex flex-col md:col"> <!-- Ocupa 2 colunas em telas maiores -->
                        ...
                        <a href="{{ route('dashboard.master.alunos') }}" class="btn btn-secondary"><button  class=" btn btn-primary w-full border bg-red-500 hover:bg-red-700 text-white border-red-500 p-2 rounded-md">Voltar</button></a> <!-- Botão responsivo com w-full -->
                    </div>
                    <div class="flex flex-col md:col"> <!-- Ocupa 2 colunas em telas maiores -->
                        <label class="font-bold mb-2">‎ </label>
                        <button  type="submit" class=" btn btn-primary w-full border bg-red-500 hover:bg-red-700 text-white border-red-500 p-2 rounded-md">Atualizar aluno</button><!-- Botão responsivo com w-full -->
                    </div>
                     </form>
                </div>
        </div>
