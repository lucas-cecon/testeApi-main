            ...
            @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4"> <!-- Responsivo: 1 coluna em telas pequenas, 2 colunas em telas maiores -->
                    ...
                    <div class="form-group flex flex-col">
                        ...
                        <input type="text" name="nome" class="form-control bg-gray-200 border border-red-500 p-2 rounded-md w-full" value="{{ old('nome', $funcionario->nome) }}" required>
                    </div>
                    <div class="form-group flex flex-col">
                        <label for="cpf" class="font-bold mb-2">CPF:</label>
                        <input name="cpf" class="form-control bg-gray-200 border border-red-500 p-2 rounded-md w-full" value="{{ old('cpf', $funcionario->cpf) }}" required>
                    ...
                    <div class="form-group flex flex-col">
                        ...
                        <input name="nif"  class="form-control bg-gray-200 border border-red-500 p-2 rounded-md w-full" value="{{ old('nif', $funcionario->nif) }}" required>
                    </div>
                    ...
                    <div class="form-group flex flex-col">
                        ...
                        <input name="senha" class="form-control bg-gray-200 border border-red-500 p-2 rounded-md w-full">
                    </div>
                    ...
                    <div class="flex flex-col md:col"> <!-- Ocupa 2 colunas em telas maiores -->
                        ...
                        <button type="submit" class=" btn btn-primary w-full border bg-red-500 hover:bg-red-700 text-white border-red-500 p-2 rounded-md">Atualizar funcionário:</button> <!-- Botão responsivo com w-full -->
                    </div>
                    <div class="flex flex-col md:col"> <!-- Ocupa 2 colunas em telas maiores -->
                        <label class="font-bold mb-2">‎ </label>
