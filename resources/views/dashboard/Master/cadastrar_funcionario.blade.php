            ...
            <form action="{{ route('dashboard.master.funcionarios.adicionar') }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="form-group flex flex-col">
                        ...
                        <select name="cargo" type="text"
                            ...
                            @foreach ($cargos as $cargo)
                                <option value="{{ $cargo->id }}" {{ old('cargo') == $cargo->id ? 'selected' : '' }}>
                    ...
                    <div class="flex flex-col md:col"> <!-- Ocupa 2 colunas em telas maiores -->
                        ...
                        <button type="submit"
                            class=" btn btn-primary w-full border bg-red-500 hover:bg-red-700 text-white border-red-500 p-2 rounded-md">Cadastrar
                            funcionário</button> <!-- Botão responsivo com w-full -->
                    </div>
                    <div class="flex flex-col md:col"> <!-- Ocupa 2 colunas em telas maiores -->
                        <label class="font-bold mb-2">‎ </label>
                        <a href="{{ route('dashboard.master.funcionario') }}"><button type="button"
