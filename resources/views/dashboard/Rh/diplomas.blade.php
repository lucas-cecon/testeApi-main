                                    ...
                                    <table class="min-w-full table-auto border-collapse border border-gray-200">
                                        <thead class="bg-gray-100 text-gray-600 text-sm uppercase font-semibold">
                                            <tr>
                                                ...
                                                <th class="border border-gray-300 px-4 py-2 text-left">Título do Diploma
                                                </th>
                                        ...
                                        <tbody class="text-gray-700 text-sm">
                                            @foreach ($diplomas as $diploma)
                                                <tr class="border-b">
                                                    <td class="border border-gray-300 px-4 py-2">{{ $diploma->id }}
                                                    </td>
                                                    <td class="border border-gray-300 px-4 py-2">{{ $diploma->titulo }}
                                                    </td>
                                                    <td class="border border-gray-300 px-4 py-2">
                                                        {{ $diploma->lote_diploma }}</td>
                                                    <td class="border border-gray-300 px-4 py-2">
                                                        {{ $diploma->quant_diploma }}</td>
                                                    <td class="border border-gray-300 px-4 py-2">
                                                        {{ $diploma->curso->curso }}</td>
                                                    <td class="border border-gray-300 px-4 py-2">
                                                        @if ($diploma->status == 1)
                                                            Aberto
                                                    ...
                                                    <td class="border border-gray-300 px-4 py-2">
                                                        <a href="{{ route('dashboard.rh.diplomas.show', $diploma->id) }}"
