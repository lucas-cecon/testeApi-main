            ...
            <form action="{{ route('diplomas.store') }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="form-group flex flex-col">
                        ...
                        <input type="text" id="lote_diploma" name="lote_diploma"
                            class="form-control bg-gray-200 border border-red-500 p-2 rounded-md w-full" required>
                    ...
                    <div class="form-group flex flex-col">
                        ...
                        <input type="number" id="quant_diploma" name="quant_diploma"
                    ...
                    <div class="flex flex-col md:col"> <!-- Ocupa 2 colunas em telas maiores -->
                        ...
                        <button type="submit"
                            class=" btn btn-primary w-full border bg-red-500 hover:bg-red-700 text-white border-red-500 p-2 rounded-md">Criar
                            diploma</button> <!-- Botão responsivo com w-full -->
                    </div>
                    <div class="flex flex-col md:col"> <!-- Ocupa 2 colunas em telas maiores -->
                        <label class="font-bold mb-2">‎ </label>
                        <a href="{{ route('dashboard.rh.diplomas') }}/"><button type="button"
