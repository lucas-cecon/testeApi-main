    ...
    <div class="flex flex-col items-center min-h-screen bg-gray-100">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-20"> <!-- Grid for responsivity -->
            ...
            <div class="flex flex-col items-center">
                ...
                <a href="{{ route('dashboard.rh.diplomas') }}">
                    <p class="mt-3 text-3x2 font-black text-center uppercase leading-snug h-16">Diplomas</p>
                </a>
            ...
            <div class="flex flex-col items-center">
                <a href="{{ route('dashboard.rh.apm') }}">
                    <div
                        class="w-32 h-32 flex items-center justify-center rounded-full shadow-lg bg-white transition transform hover:scale-110 hover:shadow-2xl">
                        <img src="{{ asset('assets/img/icone_dashboard_2.svg') }}" alt="Icon 2"
                            class="w-32 h-32 transition-opacity hover:opacity-80">
                    </div>
                </a>
                <a href="{{ route('dashboard.rh.apm') }}">
                    <p class="mt-3 text-3x2 font-black text-center uppercase leading-snug h-16">Portal da<br>AAPM</p>
                </a>
                <div class="w-16 h-1 bg-red-500 mt-5"></div>
            </div>
            ...
            <!-- Icon 3 -->
            <div class="flex flex-col items-center">
                <a href="{{ route('dashboard.rh.pedidos') }}">
                    <div
                        class="w-32 h-32 flex items-center justify-center rounded-full shadow-lg bg-white transition transform hover:scale-110 hover:shadow-2xl">
