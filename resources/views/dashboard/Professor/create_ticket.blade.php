        ...
        <div class="bg-gray-200 p-8 rounded-md shadow-md w-full max-w-2xl"> <!-- Tornado responsivo com w-full -->
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4"> <!-- Responsivo: 1 coluna em telas pequenas, 2 colunas em telas maiores -->
                ...
                <div class="flex flex-col">
                    ...
                    <textarea name="descricao" type="text" id="horario-novo" class="form-control bg-gray-200 border border-red-500 p-2 rounded-md w-full">
                    </textarea>
                </div>

                <div class="flex flex-col">
                    <label for="horario-novo" class="font-bold mb-2">Data de Início:</label>
                    <input type="date" id="horario-novo" class="bg-gray-200 border border-red-500 p-2 rounded-md w-full">
                </input>
                </div>

                <div class="flex flex-col">
                    <label for="horario-novo" class="font-bold mb-2">Data de Fim:</label>
                    <input type="date" id="horario-novo" class="bg-gray-200 border border-red-500 p-2 rounded-md w-full">
                </input>
                </div>
                ...
                <div class="flex flex-col md:col"> <!-- Ocupa 2 colunas em telas maiores -->
                    ...
                    <button class="w-full border bg-red-500 hover:bg-red-700 text-white border-red-500 p-2 rounded-md">Enviar Solicitação</button> <!-- Botão responsivo com w-full -->
                </div>
            </div>
        </div>
    </div>
