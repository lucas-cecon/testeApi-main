                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="form-group flex flex-col">
                        ...
                        <input type="text"
                            ...
                            value="{{ $horarioAtual->codigo }} ({{ $horarioAtual->hora_inicio }} - {{ $horarioAtual->hora_fim }})"
                            readonly>
                    ...
                    <div class="form-group flex flex-col">
                        ...
                        <select name="horario_novo"
                            class="form-control bg-gray-200 border border-red-500 p-2 rounded-md w-full">
                            @foreach ($horarios as $horario)
                                <option value="{{ $horario->id }}">{{ $horario->codigo }} ({{ $horario->hora_inicio }}
                                    - {{ $horario->hora_fim }})</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="form-group flex flex-col">
                        ...
                        <select name="gestor_responsavel"
                            class="form-control bg-gray-200 border border-red-500 p-2 rounded-md w-full">
                    ...
                    <div class="flex flex-col md:col"> <!-- Ocupa 2 colunas em telas maiores -->
                        ...
                        <button type="submit" id="botao"
                            class=" btn btn-primary w-full border bg-red-500 hover:bg-red-700 text-white border-red-500 p-2 rounded-md">Enviar
                            Solicitação</button> <!-- Botão responsivo com w-full -->
                    </div>
                    <div class="
                     flex flex-col md:col"> <!-- Ocupa 2 colunas em telas maiores -->
                        <label class="font-bold mb-2">‎ </label>
                        <a href="{{ route('dashboard.professor') }}"><button type="button"
