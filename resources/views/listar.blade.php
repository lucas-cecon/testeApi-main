...
<body class="font-inter bg-gray-100">
    ...
    <div class="flex flex-col items-center min-h-screen bg-gray-100 relative">
        ...
        <a href="{{ route('funcionarios.cadastrar') }}"><button class="new-order-btn"> <svg
                        ...
                        @else
                            @foreach ($funcionarios as $funcionario)
                                <tr>
                                    ...
                                    <td class="border border-gray-300 px-4 py-2">
                                        <a
                                            href="{{ route('funcionarios.editar', ['id' => $funcionario->ID_funcionario]) }}">Editar</a>
                                        <form
                                            action="{{ route('api.funcionarios.deletar', ['id' => $funcionario->ID_funcionario]) }}"
