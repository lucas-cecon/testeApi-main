                ...
                <div class="bg-white p-8 rounded-lg shadow-lg max-w-md w-full">
                    ...
                    <form action="{{ route('funcionarios.autenticar') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="cpf_nif" name="cpf_nif"
                        ...
                        <div class="mt-6">
                            <button type="submit"
                                class="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500">Login</button>
                        </div>
